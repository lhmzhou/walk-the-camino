              ...
              <div id="collapseScenariohappy0_5" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <div class="row steps">
                      ...
                      <span class="text">
                        <span class="keyword highlight">Then </span>
                          <span> cucumber-html-reporter should create HTML report with data-table</span>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" id="directory">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" href="#collapseSubSuiteoverjoyed">
                                        <i class="glyphicon glyphicon-chevron-right"></i>
                                        <i class="glyphicon glyphicon-chevron-down"></i>
                                        <b>overjoyed</b>
                                        <span class="label-container">
                                        <span class="label label-success" title="2 Features Passed">2</span>
                            ...
                            <div id="collapseSubSuiteoverjoyed" class="panel-collapse collapse">
                                <div class="panel-body">
  ...
  <div class="col-lg-6 col-md-6">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
            <div class="tags"> <span class="tag">@happy</span>  <span class="tag">@reporting</span>  </div>
          <a data-toggle="collapse" href="#collapseFeatureoverjoyed0">
            <i class="glyphicon glyphicon-chevron-right"></i>
            <i class="glyphicon glyphicon-chevron-down"></i>
            <b>Feature:</b>Happy HTML reporting
            <span class="label-container">
      ...
      <div id="collapseFeatureoverjoyed0" class="panel-collapse collapse">
        <div class="panel-body">
         <div class="description">  In order to review cucumber reports<br />  Fred, a cucumber user<br />  Wants to have cucumber reports in HTML</div>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    <div class="tags"> <span class="tag"> @testPassing</span>  </div>
                  <a data-toggle="collapse" href="#collapseScenariooverjoyed0_0">
                    <i class="glyphicon glyphicon-chevron-right"></i>
                    <i class="glyphicon glyphicon-chevron-down"></i>
                    <b>Scenario:</b>Fred wants to see passing scenarios in the HTML report
                    <span class="label-container">
              ...
              <div id="collapseScenariooverjoyed0_0" class="panel-collapse collapse">
                <div class="panel-body">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    <div class="tags"> <span class="tag"> @testScenarioOutline</span>  </div>
                  <a data-toggle="collapse" href="#collapseScenariooverjoyed0_1">
                    <i class="glyphicon glyphicon-chevron-right"></i>
                    <i class="glyphicon glyphicon-chevron-down"></i>
                    <b>Scenario:</b>Fred runs scenario outline for John and print on HTML report
                    <span class="label-container">
              ...
              <div id="collapseScenariooverjoyed0_1" class="panel-collapse collapse">
                <div class="panel-body">
                  <div class="description" id="scenario-description">John & Bob wants to run cucumber scenarios<br />  - expects to have HTML reports</div>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    <div class="tags"> <span class="tag"> @testScenarioOutline</span>  </div>
                  <a data-toggle="collapse" href="#collapseScenariooverjoyed0_2">
                    <i class="glyphicon glyphicon-chevron-right"></i>
                    <i class="glyphicon glyphicon-chevron-down"></i>
                    <b>Scenario:</b>Fred runs scenario outline for Bob and print on HTML report
                    <span class="label-container">
              ...
              <div id="collapseScenariooverjoyed0_2" class="panel-collapse collapse">
                <div class="panel-body">
                  <div class="description" id="scenario-description">John & Bob wants to run cucumber scenarios<br />  - expects to have HTML reports</div>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    <div class="tags"> <span class="tag"> @testAttachDebugData</span>  </div>
                  <a data-toggle="collapse" href="#collapseScenariooverjoyed0_3">
                    <i class="glyphicon glyphicon-chevron-right"></i>
                    <i class="glyphicon glyphicon-chevron-down"></i>
                    <b>Scenario:</b>Fred wants to print test data in the HTML reports for debugging purpose
                    <span class="label-container">
              ...
              <div id="collapseScenariooverjoyed0_3" class="panel-collapse collapse">
                <div class="panel-body">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    <div class="tags"> <span class="tag"> @testDocString</span>  </div>
                  <a data-toggle="collapse" href="#collapseScenariooverjoyed0_4">
                    <i class="glyphicon glyphicon-chevron-right"></i>
                    <i class="glyphicon glyphicon-chevron-down"></i>
                    <b>Scenario:</b>Fred wants see the long doc string attached in the HTML report
                    <span class="label-container">
              ...
              <div id="collapseScenariooverjoyed0_4" class="panel-collapse collapse">
                <div class="panel-body">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    <div class="tags"> <span class="tag"> @testDataTable</span>  </div>
                  <a data-toggle="collapse" href="#collapseScenariooverjoyed0_5">
                    <i class="glyphicon glyphicon-chevron-right"></i>
                    <i class="glyphicon glyphicon-chevron-down"></i>
                    <b>Scenario:</b>Fred wants to use data table and print on HTML report
                    <span class="label-container">
              ...
              <div id="collapseScenariooverjoyed0_5" class="panel-collapse collapse">
                <div class="panel-body">
  ...
  <div class="col-lg-6 col-md-6">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
            <div class="tags"> <span class="tag">@happy</span>  <span class="tag">@reporting</span>  </div>
          <a data-toggle="collapse" href="#collapseFeatureoverjoyed1">
            <i class="glyphicon glyphicon-chevron-right"></i>
            <i class="glyphicon glyphicon-chevron-down"></i>
            <b>Feature:</b>Happy HTML reporting
            <span class="label-container">
      ...
      <div id="collapseFeatureoverjoyed1" class="panel-collapse collapse">
        <div class="panel-body">
         <div class="description">  In order to review cucumber reports<br />  Fred, a cucumber user<br />  Wants to have cucumber reports in HTML</div>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    <div class="tags"> <span class="tag"> @testPassing</span>  </div>
                  <a data-toggle="collapse" href="#collapseScenariooverjoyed1_0">
                    <i class="glyphicon glyphicon-chevron-right"></i>
                    <i class="glyphicon glyphicon-chevron-down"></i>
                    <b>Scenario:</b>Fred wants to see passing scenarios in the HTML report
                    <span class="label-container">
              ...
              <div id="collapseScenariooverjoyed1_0" class="panel-collapse collapse">
                <div class="panel-body">
                      ...
                      <span class="text">
                        <span class="keyword highlight">Before </span>
                          <span> </span>
                           ...
                           <a href="#info1_01" data-toggle="collapse">+ Show Info</a>
                           <div id="info1_01" class="collapse">
                             <pre class=info>Tests INFO will print here.<br>To attach INFO to Any steps, use scenario.attach function in your step definitions as shown below.<br><br>If you pass HTML's to scenario.attach then reporter will format accordingly <br><br>Simple String  : scenario.attach('sample data')<br>Pretty JSON    : scenario.attach(JSON.stringify(json, null, 2))<br>HTML Link      : scenario.attach('format the link with html-a tag'</pre>
                           </div>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    <div class="tags"> <span class="tag"> @testScenarioOutline</span>  </div>
                  <a data-toggle="collapse" href="#collapseScenariooverjoyed1_1">
                    <i class="glyphicon glyphicon-chevron-right"></i>
                    <i class="glyphicon glyphicon-chevron-down"></i>
                    <b>Scenario:</b>Fred runs scenario outline for John and print on HTML report
                    <span class="label-container">
              ...
              <div id="collapseScenariooverjoyed1_1" class="panel-collapse collapse">
                <div class="panel-body">
                  <div class="description" id="scenario-description">John & Bob wants to run cucumber scenarios<br />  - expects to have HTML reports</div>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    <div class="tags"> <span class="tag"> @testScenarioOutline</span>  </div>
                  <a data-toggle="collapse" href="#collapseScenariooverjoyed1_2">
                    <i class="glyphicon glyphicon-chevron-right"></i>
                    <i class="glyphicon glyphicon-chevron-down"></i>
                    <b>Scenario:</b>Fred runs scenario outline for Bob and print on HTML report
                    <span class="label-container">
              ...
              <div id="collapseScenariooverjoyed1_2" class="panel-collapse collapse">
                <div class="panel-body">
                  <div class="description" id="scenario-description">John & Bob wants to run cucumber scenarios<br />  - expects to have HTML reports</div>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    <div class="tags"> <span class="tag"> @testAttachDebugData</span>  </div>
                  <a data-toggle="collapse" href="#collapseScenariooverjoyed1_3">
                    <i class="glyphicon glyphicon-chevron-right"></i>
                    <i class="glyphicon glyphicon-chevron-down"></i>
                    <b>Scenario:</b>Fred wants to print test data in the HTML reports for debugging purpose
                    <span class="label-container">
              ...
              <div id="collapseScenariooverjoyed1_3" class="panel-collapse collapse">
                <div class="panel-body">
                      ...
                      <span class="text">
                        <span class="keyword highlight">Given </span>
                          <span> Fred attaches the "test data to be printed" to the Given step of passing cucumber scenario</span>
                           ...
                           <a href="#info1_32" data-toggle="collapse">+ Show Info</a>
                           <div id="info1_32" class="collapse">
                             <pre class=info>test data to be printed<br>{
  "name": "cucumber-html-reporter",
  "format": "html"
}</pre>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    <div class="tags"> <span class="tag"> @testDocString</span>  </div>
                  <a data-toggle="collapse" href="#collapseScenariooverjoyed1_4">
                    <i class="glyphicon glyphicon-chevron-right"></i>
                    <i class="glyphicon glyphicon-chevron-down"></i>
                    <b>Scenario:</b>Fred wants see the long doc string attached in the HTML report
                    <span class="label-container">
              ...
              <div id="collapseScenariooverjoyed1_4" class="panel-collapse collapse">
                <div class="panel-body">
...
I want to print below Doc String
  ...
  Hey, I am a Doc string
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    <div class="tags"> <span class="tag"> @testDataTable</span>  </div>
                  <a data-toggle="collapse" href="#collapseScenariooverjoyed1_5">
                    <i class="glyphicon glyphicon-chevron-right"></i>
                    <i class="glyphicon glyphicon-chevron-down"></i>
                    <b>Scenario:</b>Fred wants to use data table and print on HTML report
                    <span class="label-container">
              ...
              <div id="collapseScenariooverjoyed1_5" class="panel-collapse collapse">
                <div class="panel-body">
            ...
            <div class="panel panel-default">
                <div class="panel-heading" id="directory">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" href="#collapseSuiteunhappy">
                            <i class="glyphicon glyphicon-chevron-right"></i>
                            <i class="glyphicon glyphicon-chevron-down"></i>
                            <b>unhappy</b>
                            <span class="label-container">
                            <span class="label label-success" title="1 Features Passed">1</span>
                ...
                <div id="collapseSuiteunhappy" class="panel-collapse collapse">
                    <div class="panel-body">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          ...
          <a data-toggle="collapse" href="#collapseFeatureunhappy0">
            <i class="glyphicon glyphicon-chevron-right"></i>
            <i class="glyphicon glyphicon-chevron-down"></i>
            <b>Feature:</b>Unhappy HTML reporting
            <span class="label-container">
              <span class="label label-success" title="2 Scenarios Passed">2</span>
              
              <span class="label label-info" title="1 Scenarios Undefined">1</span>
              <span class="label label-default" title="1 Scenarios Pending">1</span>
      ...
      <div id="collapseFeatureunhappy0" class="panel-collapse collapse">
        <div class="panel-body">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                  ...
                  <a data-toggle="collapse" href="#collapseScenariounhappy0_0">
                    <i class="glyphicon glyphicon-chevron-right"></i>
                    <i class="glyphicon glyphicon-chevron-down"></i>
                    <b>Scenario:</b>Fred wants to see a Screenshot attached to the HTML report
                    <span class="label-container">
                      <span class="label label-success" title="4 Steps Passed">4</span>
              ...
              <div id="collapseScenariounhappy0_0" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <div class="row steps">
                      ...
                      <span class="text">
                        <span class="keyword highlight">Given </span>
                          <span> Fred runs a failing cucumber scenario</span>
                    ...
                    <div class="row steps">
                      ...
                      <span class="text">
                        <span class="keyword highlight">And </span>
                          <span> a failing scenario captures a screenshot</span>
                    ...
                    <div class="row steps">
                      ...
                      <span class="text">
                        <span class="keyword highlight">Then </span>
                          <span> cucumber-html-reporter should create HTML report with Screenshot</span>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                  ...
                  <a data-toggle="collapse" href="#collapseScenariounhappy0_1">
                    <i class="glyphicon glyphicon-chevron-right"></i>
                    <i class="glyphicon glyphicon-chevron-down"></i>
                    ...
                    <span class="label-container">
                      ...
                      <span class="label label-default" title="1 Steps Pending">1</span>
                      <span class="label label-warning" title="1 Steps Skipped">1</span>
              ...
              <div id="collapseScenariounhappy0_1" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <div class="row steps">
                      ...
                      <span class="text">
                        <span class="keyword highlight">Given </span>
                          <span> Fred runs a cucumber scenario</span>
                    ...
                    <div class="row steps">
                      ...
                      <span class="text">
                        <span class="keyword highlight">When </span>
                          <span> he left this step as a pending</span>
                    ...
                    <div class="row steps">
                      ...
                      <span class="text">
                        <span class="keyword highlight">Then </span>
                          <span> cucumber-html-reporter should report pending step with code-snippets in HTML report</span>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                  ...
                  <a data-toggle="collapse" href="#collapseScenariounhappy0_2">
                    <i class="glyphicon glyphicon-chevron-right"></i>
                    <i class="glyphicon glyphicon-chevron-down"></i>
                    <b>Scenario:</b>Fred wants to see if steps are undefined on the HTML report
                    <span class="label-container">
                      <span class="label label-success" title="1 Steps Passed">1</span>
                      <span class="label label-info" title="2 Steps Undefined">2</span>
              ...
              <div id="collapseScenariounhappy0_2" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <div class="row steps">
                      ...
                      <span class="text">
                        <span class="keyword highlight">When </span>
                          <span> he left this step as a undefined</span>
...
this.Then(/^he left this step as a undefined$/, function(callback) {
  ...
  callback(null, 'pending');
                    ...
                    <div class="row steps">
                      ...
                      <span class="text">
                        <span class="keyword highlight">Then </span>
                          <span> cucumber-html-reporter should create undefined step in HTML report</span>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    <div class="tags"> <span class="tag"> @ambiguousStep</span>  </div>
                  <a data-toggle="collapse" href="#collapseScenariounhappy0_3">
                    <i class="glyphicon glyphicon-chevron-right"></i>
                    <i class="glyphicon glyphicon-chevron-down"></i>
                    <b>Scenario:</b>Fred wants to see if steps are ambiguous on the HTML report
                    <span class="label-container">
                      <span class="label label-success" title="3 Steps Passed">3</span>
              ...
              <div id="collapseScenariounhappy0_3" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <div class="row steps">
                      ...
                      <span class="text">
                        <span class="keyword highlight">When </span>
                          <span> he left this step to be ambiguous</span>
                    ...
                    <div class="row steps">
                      ...
                      <span class="text">
                        <span class="keyword highlight">Then </span>
                          <span> cucumber-html-reporter should create HTML report with ambiguous steps</span>
    ...
    <div class="navbar-fixed-bottom row-fluid footer-div ">
      <div class="navbar-inner">
        <div class="footer-container">
            <a  target="_blank" href="https://aexp-merchant.slack.com/messages/CA0H2SZS4/">
                <div class="text-muted footer-link">
                    powered by @best-buddies
                </div>
            </a>
        </div>
      </div>
